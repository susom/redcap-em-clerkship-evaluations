...
<div id="app" class="container">
    ...
    <div class="row p-1">
        <table id="review-table" class="display table table-striped table-bordered">
            ...
            $specialties = $module->getProject()->metadata['specialty']["element_enum"];
            ...
            if ($reviews) {
                foreach ($reviews as $id => $review) {
                    ...
                    <tr>
                        ...
                        <td><?php echo Rotation::getSpecialtyValue($specialties, $rotation[$module->getRotation()->getEventId()]['specialty']) ?></td>
                        <td>
                            <?php
